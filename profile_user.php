            ...
            <div class="collapse navbar-collapse">
                ...
                <div class="nav-item dropdown no-caret dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        ...
                        <a class="dropdown-item" href="dashboard_user.php?id=<?= $id ?>">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="d-flex flex-column align-items-center text-center p-3">
                        ...
                        <a href="dashboard_user.php?id=<?= $id ?>" class="btn btn-primary mx-5 mt-5">Dashboard</a>
                    </div>
                </div>
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-6"><label class="labels fw-bold">Alamat</label><br>
                            <p><?= $user[0]['alamat'] ?></p></div>
                ...
                <div class="col-4">
                    <div class="p-3 py-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center experience"><span class="fw-bold">Kamar</span><span class="border px-3 p-1 add-experience"><?= $user[0]['id_kamar'] ?></span></div><br>
                        <div class="d-flex justify-content-between align-items-center experience"><span class="fw-bold">Tanggal Lahir</span><span class="border px-3 p-1 add-experience"><?= $user[0]['tanggal_lahir'] ?></span></div><br></div>
                    </div>
                </div>
            </div>
        </div>
